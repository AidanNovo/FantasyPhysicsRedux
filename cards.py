...
card_dict = {
    ...
    'Neutrino Oscill.': Card(name='Neutrino Oscill.', card_type='physics', tags=['neutrino'],
                             image_file='fp_small_neutrino_oscillation.png', rarity=vars.r_rare,
