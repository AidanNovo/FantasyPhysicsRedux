...
data = 0
score = 0
# Integer number of power tokens, generated by things like nuclear reactors. Starts at 2 to represent grid power (and
# to not be too punishing if people get bad draws)
unused_power_tokens = 2

deck = []
active_row = []
max_active_cards = 7  # The max number of cards that may be in the active row
