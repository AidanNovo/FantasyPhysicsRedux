...
can be pointed towards a specific detector. In real life, these neutrinos are pointed towards the 
[DUNE Near Detector]({{ 'cards/dune_enear_detector' | relative_url}}) and the 
[DUNE Far Detector]({{ 'cards/dune_far_detector' | relative_url}})!
...
detector is very close to the beam, while the far detector is many miles away in South Dakota.
...
### Want to learn more? 
Check out [their website](https://lbnf-dune.fnal.gov/​)!
